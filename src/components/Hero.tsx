      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <div className="text-purple-400 font-medium text-lg mb-4 tracking-wider mt-6">
              🎬 Creative Video Production & Editing
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight mt-6">
              WinConch
              <br />
            ...
            className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/25 mt-6">
              LET'S TALK
            </button>
            <Link
            to="/projects" >
             <button className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/25 mr-4 ml-4  mt-4">
              View Our Work
            </button>
            </Link>
          </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div className="relative w-80 h-80 bg-gradient-to-b from-gray-700 to-gray-800 rounded-2xl flex items-center justify-center shadow-2xl">
